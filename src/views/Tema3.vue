  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    ul.lista-ul--color
      li(style="margin-bottom: 2px")
        i.fas.fa-check-circle(style="color: #FE7062;" data-aos="fade-right")
        p.mb-0 Constante y duro trabajo conjunto.
      li(style="margin-bottom: 2px")
        i.fas.fa-check-circle(style="color: #FE7062;" data-aos="fade-right")
        p.mb-0 Cada parte debe entender las necesidades del otro.
      li(style="margin-bottom: 2px")
        i.fas.fa-check-circle(style="color: #FE7062;" data-aos="fade-right")
        p.mb-0 Deben ser compatibles.
      li(style="margin-bottom: 2px")
        i.fas.fa-check-circle(style="color: #FE7062;" data-aos="fade-right")
        p.mb-0 Flexibilidad.
      li(style="margin-bottom: 2px")
        i.fas.fa-check-circle(style="color: #FE7062;" data-aos="fade-right")
        p.mb-0 En las buenas y en las malas.
      li(style="margin-bottom: 2px")
        i.fas.fa-check-circle(style="color: #FE7062;" data-aos="fade-right")
        p.mb-0 Contrato a largo plazo.
      li(style="margin-bottom: 2px")
        i.fas.fa-check-circle(style="color: #FE7062;" data-aos="fade-right")
        p.mb-0 Compromiso y soporte de la alta dirección.
      li(style="margin-bottom: 2px")
        i.fas.fa-check-circle(style="color: #FE7062;" data-aos="fade-right")
        p.mb-0 Compromiso multifuncional entre los socios.
      li(style="margin-bottom: 2px")
        i.fas.fa-check-circle(style="color: #FE7062;" data-aos="fade-right")
        p.mb-0 Filosofía gana-gana
    ...
    AcordionA.mb-5(tipo="b" clase-tarjeta="tarjeta fondo-casi-blanco" data-aos="zoom-in")
      ...
      div(titulo="Convenio de Basilea")
        ...
        p.mb-0 El seguimiento e implementación del Convenio está en cabeza del Ministerio de Ambiente y Desarrollo Sostenible.
      div(titulo="Convenio de Rotterdam")
        ...
        p.mb-0 El seguimiento e implementación del Convenio está en cabeza de los Ministerios de Ambiente y Desarrollo Sostenible y de Salud y Protección Social, así como del Instituto Colombiano Agropecuario ICA.
    ...
    AcordionA.mb-5(tipo="b" clase-tarjeta="tarjeta fondo-purpura-medio" data-aos="zoom-in")
      .row(titulo="ISO 14000")
        p.mb-0 Establece los criterios para un sistema de gestión ambiental.
      div(titulo="ISO 9001")
        p.mb-0 Esta norma se basa en una serie de principios de gestión de la calidad que incluyen un fuerte enfoque en el cliente, la motivación y la implicación de la alta dirección, el enfoque de procesos y la mejora continua.
      div(titulo="ISO 3394")
        p.mb-0 Hace referencia a las dimensiones de las cajas master, de los pallets o plataformas y de las cargas paletizadas.
      div(titulo="ISO 780")
        p.mb-0 La norma específica las características de los símbolos utilizados de una manera convencional para el marcado de embalajes de expedición con el fin de transmitir prescripciones de manipulación.
      div(titulo="ISO 7000")
        p.mb-0 Esta norma se refiere al rótulo y marca de un empaque para ayudar a identificar los productos, su manejo y ubicación.
      ...
      .col-lg-10.fondo-purpura-medio.p-5
        .row.align-items-center
          ...
          .col-lg-7
            ...
            a.boton.color-acento-botones(:href="obtenerLink('/downloads/Seguridad_y_salud_en_el_trabajo_OHSAS_18001.pdf')" target="_blank" type="application/pdf")
              span Descargar
