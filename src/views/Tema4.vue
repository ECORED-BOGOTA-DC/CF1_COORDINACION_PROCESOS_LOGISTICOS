...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    #t_4_1.titulo-segundo.color-acento-botones(data-aos="fade-right")
      h2 4.1.	#[em Benchmarking] qué es, cómo funciona, utilidad
    ...
    .col-lg-10.mx-auto.mb-4(data-aos="flip-up")
      ...
      .col-lg-9.mb-5.mx-auto
        .bloque-texto-b.bloque-texto-cac.p-4
          .bloque-texto-b__texto
            ...
            p.mb-0 Es necesario recordar que todo se mide y que los indicadores son necesarios para poder mejorar: “Lo que no se mide no se puede controlar, y lo que no se controla no se puede gestionar”.
      ...
      div(titulo="Objetivos")
        ul.lista-ul--color.lista-ul--separador
          li(style="margin-bottom: 2px")
            ...
            p.mb-0 Identificar y tomar acciones sobre los problemas operativos.
          li(style="margin-bottom: 2px")
            i.fas.fa-check-circle(style="color: #FE7062;")
            p.mb-0 Medir el grado de competitividad de la empresa frente a sus competidores nacionales e internacionales.
          li(style="margin-bottom: 2px")
            i.fas.fa-check-circle(style="color: #FE7062;")
            p.mb-0 Satisfacer las expectativas del cliente mediante la reducción del tiempo de entrega y la optimización del servicio prestado.
          li(style="margin-bottom: 2px")
            i.fas.fa-check-circle(style="color: #FE7062;")
            p.mb-0 Mejorar el uso de los recursos y activos asignados, para aumentar la productividad y efectividad en las diferentes actividades hacia el cliente final.
          li(style="margin-bottom: 2px")
            i.fas.fa-check-circle(style="color: #FE7062;")
            p.mb-0 Reducir gastos y aumentar la eficiencia operativa.
          li(style="margin-bottom: 2px")
            i.fas.fa-check-circle(style="color: #FE7062;")
            p.mb-0 Compararse con las empresas del sector en el ámbito local y mundial (Benchmarking).
      div(titulo="Utilidades")
        ul.lista-ul--color.lista-ul--separador
          li(style="margin-bottom: 2px")
            i.fas.fa-check-circle(style="color: #FE7062;")
            p.mb-0 Parametrizador de la planeación de actividades logísticas.
          li(style="margin-bottom: 2px")
            i.fas.fa-check-circle(style="color: #FE7062;")
            p.mb-0 Medición de resultados.
          li(style="margin-bottom: 2px")
            i.fas.fa-check-circle(style="color: #FE7062;")
            p.mb-0 Proyección de logros.
          li(style="margin-bottom: 2px")
            i.fas.fa-check-circle(style="color: #FE7062;")
            p.mb-0 Identificación de mejoras internas.
          li(style="margin-bottom: 2px")
            i.fas.fa-check-circle(style="color: #FE7062;")
            p.mb-0 Dinamizador de los procesos logísticos de mercancías mediante la interrelación de todas sus actividades internas (armonía).
          li(style="margin-bottom: 2px")
            i.fas.fa-check-circle(style="color: #FE7062;")
            p.mb-0 Potencializador de la actividad comercial.
          li(style="margin-bottom: 2px")
            i.fas.fa-check-circle(style="color: #FE7062;")
            p.mb-0 Multiplicador de la realidad empresarial.
          li(style="margin-bottom: 2px")
            i.fas.fa-check-circle(style="color: #FE7062;")
            p.mb-0 Capacidad real.
          li(style="margin-bottom: 2px")
            i.fas.fa-check-circle(style="color: #FE7062;")
            p.mb-0 Capacidad instalada.
    ...
    .row.align-items-start.lista-grande.mb-5
      ...
      .col-lg-6
        ol.lista-ol--circulo.lista-ol--separador
          li.align-items-center(data-aos="fade-right")
      ...
      .col-lg-6
        ol.lista-ol--circulo.lista-ol--separador
          li.align-items-center(data-aos="fade-left")
            .lista-ol--circulo__vineta
              span 6
